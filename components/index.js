...
export { default as Setting } from './Svg/internal/setting.svg';
export { default as Delete } from './Svg/internal/delete.svg';
export { default as User } from './Svg/internal/user.svg';
export { default as Start } from './Svg/internal/start.svg';
export { default as Stop } from './Svg/internal/stop.svg';
export { default as Stat } from './Svg/internal/stat.svg';
export { default as New } from './Svg/internal/new.svg';
export { default as Autoplay } from './Svg/internal/autoplay.svg';
export { default as Company } from './Svg/internal/company.svg';
...
export * from './EmploeeCard/EmploeeUserCard';
export * from './EmploeeCard/ModalSettingsUser';
export * from './EmploeeCard/ModalAddNewUser';
export * from './EmploeeWorkerCard/EmploeeWorkerCard';

export * from './OutsourceCard/OutsourceCard';
export * from './OutsourceCard/OutsourceTaskCard';
export * from './OutsourceCard/ModalNewOutsourceTask';
export * from './OutsourceCard/ModalSettingsOutsource';
export * from './OutsourceCard/WageDynamic';
